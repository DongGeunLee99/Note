  ...
  return (
    <div className="p-3 flex flex-col gap-3 h-full overflow-auto">
      ...
      >
        ...
        <div>
          <p className="text-[calc(11px*var(--fs))] font-medium" style={{ color: 'var(--color-primary-emphasis)' }}>오전 7:30</p>
          <p className="text-[calc(9px*var(--fs))]" style={{ color: 'var(--color-primary)' }}>기상 · 직장</p>
        </div>
      </div>
      ...
      {HOME_CATEGORIES.map(cat => {
        ...
        return (
          <div key={cat} className="flex items-center justify-between text-[calc(10px*var(--fs))]">
